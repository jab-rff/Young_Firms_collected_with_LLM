...
def prepare_review_row(record: dict[str, Any]) -> dict[str, str]:
    return {
        ...
        "origin_track": str(record.get("origin_track") or ""),
        ...
        "danish_founders_abroad": str(record.get("danish_founders_abroad") or ""),
        ...
        "founder_danish_context": str(record.get("founder_danish_context") or ""),
        ...
        "sources_founder_identity": " | ".join(str(value) for value in record.get("sources_founder_identity") or []),
