...
def test_parse_candidate_cases_preserves_schema_and_defaults() -> None:
    source_record = {
        ...
        "short_reason": "Possible Copenhagen origin and later US base.",
    }
    payload = {
        "candidates": [
            {
...
def test_parse_candidate_cases_excludes_founding_year_1998() -> None:
    source_record = {
        "firm_name": "OldCo",
        "discovery_bucket": "sector:design",
        "discovery_buckets": ["sector:design"],
        "source_urls": ["https://example.com/oldco"],
        "short_reason": "Possible relocation story.",
    }
    payload = {
        "candidates": [
            {
                ...
                "ma_co_occurred": "false",
                "ma_type": "unknown",
                "founding_evidence": "Founded in Copenhagen in 1998.",
...
def test_parse_candidate_cases_keeps_founding_year_1999() -> None:
    source_record = {
        "firm_name": "NewCo",
        "discovery_bucket": "sector:design",
        "discovery_buckets": ["sector:design"],
...
def test_parse_candidate_cases_excludes_unknown_year_without_post_1999_support() -> None:
    source_record = {
        ...
        "short_reason": "Possible relocation story.",
        "possible_founding_location": "Denmark",
